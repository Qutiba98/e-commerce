        ...
        <div class="col-10">
              ...
              <div class="card-body p-4">
                <div class="row d-flex justify-content-between align-items-center">
                  <div class="col-md-2 col-lg-2 col-xl-2">
                    <img src="images/<?php echo $showImage ?>" class="img-fluid rounded-3" alt="Cotton T-shirt" />
                  </div>
          ...
          <div class="card mb-4">
            <div class="card-body p-4 d-flex flex-row">
              ...
              <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-warning btn-lg ms-3">
                Apply
              </button>
            </div>
          </div>
