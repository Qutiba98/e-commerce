...
<head>
	...
	<link rel="canonical" href="https://demo-basic.adminkit.io/ui-typography.php" />
						...
						<div class="col-12 col-lg-6">
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">All php headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>, are available.</h6>
								</div>
								<div class="card-body">
						...
						<div class="col-12 col-lg-6">
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Styling for common inline php5 elements.</h6>
								</div>
								<div class="card-body">
