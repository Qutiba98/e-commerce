					...
					require'db.php';
							...
							?>
								...
								<div class="mb-3" style="margin-top:20px">
										<button onclick="GoToPage()" class="btn btn-secondary" style="float:right ; margin-bottom:20px">add user</button>
								</div>
...
<i>
	...
	<a  href="http://localhost/e-commerce/backend/admin-dasboard/static/update-user-page.php?user_id=<?php echo $user['user_id']; ?>" class="d-inline-block">
		<svg  style="color:#5bc0de" id="edit" onclick="editUser(<?php echo $user['user_id']; ?>)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit align-middle me-2">
...
<a href="#" class="d-inline-block" onclick="deleteUser(<?php echo $user['user_id']; ?>); return false;">
...
function deleteUser(userId) {
    fetch(`http://localhost/e-commerce/backend/users_API/delete.php?user_id=${userId}`, {
        method: 'DELETE'
    })
    .then(response => {
        if (response.ok) {
