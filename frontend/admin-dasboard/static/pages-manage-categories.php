...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy9v2Y2EM/rU2wBX9E7k0ZZA3cs+IN6hmRNVzH4" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.10.2/dist/umd/popper.min.js" integrity="sha384-oBqDVmMz4fnFO9x04p5kND8X5L5kKJ0Jf7kFsl6oWc9a4sEw5W4Wu0HeWqB2E4kT" crossorigin="anonymous"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-7yWQ4+d8R5yW/7rC6Gm8kCRdLC/mZ8sO3w4lM3Zg2pfL5bX7t5zdJg8dT58E3Jk8" crossorigin="anonymous"></script>
</head>
...
<body>
        ...
        <div class="card">
								...
								<div class="mb-3" style="margin-top:20px">
										<button onclick="GoToPage()" class="btn btn-secondary" style="float:right ; margin-bottom:20px">add category </button>
								</div>
                ...
                <?php while ($category = mysqli_fetch_assoc($categories)) : ?>
					...
					<td><?php echo $category['name']; ?></td>
                        ...
                        <td>
                            ...
                            <a href="update-categiores-page.php?id=<?php echo $category['id']; ?>" class="d-inline-block">
                            ...
                            <a href="#" class="d-inline-block" onclick="deleteProduct(<?php echo  $category['id']; ?>); return false;">
   ...
   <script>
    ...
    fetch(`http://localhost/e-commerce/backend/admin-categories_API/delete.php?id=${userId}`, {
        method: 'DELETE'
    })
    .then(response => {
        if (response.ok) {
